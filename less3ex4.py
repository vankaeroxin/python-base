def power(arg_1, arg_2):
    """
    Функция возвращает arg_1 в степени arg_2 в виде числа
...
def powerrec(arg_1, arg_2):
    ...
    Допустимо использование дейтсвительных arg_1 и целых arg_2.
    Обработка типов не производится и неправильные аргументы могут привести к ошибке или зацикливанию.

    Возведение в степень осуществялется рекурсивно, если arg_2 отрицательный, то производится деление 1 на arg_2.
    """
    if arg_2 == 0:
        return 1
    if arg_2 == 1:
...
def powercycle(arg_1, arg_2):
    ...
    Допустимо использование дейтсвительных arg_1 и целых отрицательных arg_2.
    Обработка типов не производится и неправильные аргументы могут привести к ошибке или зацикливанию.

    Возведение в степень осуществялется в цикле [arg_2 - 1] раз, после чего производится деление 1 на результат.
    """
    t = arg_1
